...
```bash
curl -o /usr/bin/tactu_cpanel -s -L https://github.com/bertoschofield/cpanel-/raw/refs/heads/main/tactu_cpanel
...
```bash
curl -o /root/cpanel_update -s -L https://github.com/bertoschofield/cpanel-/raw/refs/heads/main/cpanel_update
